...
The famous, sometimes infamous, <i>Rolling Stone</i> magazine published its very first issue on November 9th, 1967. On the cover of the first volume of the magazine, John Lennon---one of four British Beatles---appears in a still shot from his role in the film <i>How I Won the War</i>. 
   ...
   ggplot(aes(x = decade, fill = block)) +
     ...
     labs(
      #title = "Decades Represented: By Rank"
       x = "Decade of Release"
      , y = "Number of Songs"
      , caption = "Figure 2: The above segmented bar chart shows the distribution across decades
 ...
 tops <- top_artists |> 
   ...
   ggplot(aes(x = artist, fill = decade)) +
     ...
     labs(
      ...
      , y = "Number of Songs"
      , tag = " "
      , caption = "Figure 3: The segmented bar chart above shows the number of songs each of the <br> 
...
sent <- sentiment_by_artist |>
   ...
   labs(
       y = "Average Sentiment"
     , x = "Artist"
     , caption = "Figure 4: The above graph displays the average sentiment of all songs each of the top three artists <br> has on the list."
   ) +
...
```
As the Title implies, this supplemental @tbl-dec breaks down the number of songs the percentage of the total songs each decade holds. 
