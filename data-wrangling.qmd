...
read_csv("data/songs_chart.csv")

# top artists
write_csv(top_artists, "data/top_artists.csv")

# top artist average sentiment
write_csv(sentiment_by_artist, "data/sentiment_by_artists")
```
...
new_palette <- colorRampPalette(colors = c("#6b34eb"
                        ...
                        ,   "#540340"
                        ,   "#C6C2B8" ))(6)
new_palette2 <- colorRampPalette(colors = c("#6b34eb"
                        , "blue"
                        ,  "#CD7F32"
                        ,   "#C0C0C0"
                        ,   "#f5c507"
