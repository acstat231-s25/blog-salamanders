...
songs_clean <- songs |> 
  ...
  mutate(track_gen = str_remove(track, "-..")
         , block = case_when(
           number < 101  ~ "t100"
           , number > 100 & number < 201 ~ "t200"
           , number > 200 & number < 301 ~ "t300"
           , number > 300 & number < 401 ~ "t400"
           , number > 400 & number < 501 ~ "t500"
         ),
         time = ms(time))
songs_clean$bpm <- as.numeric(songs_clean$bpm)
