...
Rock1 <- ggplot(Rock_word_freqs |> 
  ...
  theme(legend.position = "none",  
     ...
     labs(
      caption = "Figure 1: Word cloud for Rock genre in the 1970s") +
     theme_linedraw() +
...
Rock2 <- ggplot(Rock_word_freqs |> 
  ...
  theme(legend.position = "none",  
        plot.background = element_rect(fill = "white", color = "white")) +
     labs(
      caption = "Figure 2: Word cloud for word frequencies in Rock genre in the 1980s") +
     theme_linedraw() +
     theme(plot.caption = ggtext::element_markdown(hjust = 0, vjust = -1
                                                   , size = rel(0.92)
                                                   , color = "#3b3d3c"
...
Rock3 <- ggplot(Rock_word_freqs |> 
  ...
  theme(legend.position = "none", 
        plot.background = element_rect(fill = "white", color = "white")) +
     labs(
      caption = "Figure 3: Word cloud for word frequencies in Rock genre in the 1990s") +
     theme_linedraw() +
     theme(plot.caption = ggtext::element_markdown(hjust = 0, vjust = -1
                                                   , size = rel(0.92)
                                                   , color = "#3b3d3c"
...
Rock4 <- ggplot(Rock_word_freqs |> 
  ...
  theme(legend.position = "none", 
        plot.background = element_rect(fill = "white", color = "white")) +
     labs(
      caption = "Figure 4: Word cloud for word frequencies in Rock genre in the 2000s") +
     theme_linedraw() +
     theme(plot.caption = ggtext::element_markdown(hjust = 0, vjust = -1
                                                   , size = rel(0.92)
                                                   , color = "#3b3d3c"
...
Dance1 <- ggplot(Dance_word_freqs |> 
  ...
  theme(legend.position = "none",  
        plot.background = element_rect(fill = "white", color = "white")) +
     labs(
      caption = "Figure 5: Word cloud for word frequencies in Dance genre in the 1960s") +
     theme_linedraw() +
     theme(plot.caption = ggtext::element_markdown(hjust = 0, vjust = -1
                                                   , size = rel(0.92)
                                                   , color = "#3b3d3c"
...
Dance2 <- ggplot(Dance_word_freqs |> 
  ...
  theme(legend.position = "none",  
        plot.background = element_rect(fill = "white", color = "white")) +
     labs(
      caption = "Figure 6: Word cloud for word frequencies in Dance genre in the 1970s") +
     theme_linedraw() +
     theme(plot.caption = ggtext::element_markdown(hjust = 0, vjust = -1
                                                   , size = rel(0.92)
                                                   , color = "#3b3d3c"
...
Dance3 <- ggplot(Dance_word_freqs |> 
  ...
  theme(legend.position = "none", 
        plot.background = element_rect(fill = "white", color = "white")) +
     labs(
      caption = "Figure 7: Word cloud for word frequencies in Dance genre in the 1980s") +
     theme_linedraw() +
     theme(plot.caption = ggtext::element_markdown(hjust = 0, vjust = -1
                                                   , size = rel(0.92)
                                                   , color = "#3b3d3c"
