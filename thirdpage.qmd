...
Rock1 <- ggplot(Rock_word_freqs |> 
  ...
  theme(legend.position = "none",  
     ...
     labs(
      caption = "Figure 1: Word cloud for Rock genre in the 1970's") +
     theme_linedraw() +
...
Rock2 <- ggplot(Rock_word_freqs |> 
  ...
  theme(legend.position = "none",  
        plot.background = element_rect(fill = "white", color = "white")) +
     labs(
      caption = "Figure 2: Word cloud for word frequencies in Rock genre in the 1980's") +
     theme_linedraw() +
     theme(plot.caption = ggtext::element_markdown(hjust = 0, vjust = -1
                                                   , size = rel(0.92)
                                                   , color = "#3b3d3c"
...
Rock3 <- ggplot(Rock_word_freqs |> 
  ...
  theme(legend.position = "none", 
        plot.background = element_rect(fill = "white", color = "white")) +
     labs(
      caption = "Figure 3: Word cloud for word frequencies in Rock genre in the 1990's") +
     theme_linedraw() +
     theme(plot.caption = ggtext::element_markdown(hjust = 0, vjust = -1
                                                   , size = rel(0.92)
                                                   , color = "#3b3d3c"
...
Rock4 <- ggplot(Rock_word_freqs |> 
  ...
  theme(legend.position = "none", 
        plot.background = element_rect(fill = "white", color = "white")) +
     labs(
      caption = "Figure 4: Word cloud for word frequencies in Rock genre in the 2000's") +
     theme_linedraw() +
     theme(plot.caption = ggtext::element_markdown(hjust = 0, vjust = -1
                                                   , size = rel(0.92)
                                                   , color = "#3b3d3c"
...
Dance1 <- ggplot(Dance_word_freqs |> 
  ...
  theme(legend.position = "none",  
        plot.background = element_rect(fill = "white", color = "white")) +
     labs(
      caption = "Figure 5: Word cloud for word frequencies in Dance genre in the 1960's") +
     theme_linedraw() +
     theme(plot.caption = ggtext::element_markdown(hjust = 0, vjust = -1
                                                   , size = rel(0.92)
                                                   , color = "#3b3d3c"
...
Dance2 <- ggplot(Dance_word_freqs |> 
  ...
  theme(legend.position = "none",  
        plot.background = element_rect(fill = "white", color = "white")) +
     labs(
      caption = "Figure 6: Word cloud for word frequencies in Dance genre in the 1970's") +
     theme_linedraw() +
     theme(plot.caption = ggtext::element_markdown(hjust = 0, vjust = -1
                                                   , size = rel(0.92)
                                                   , color = "#3b3d3c"
...
Dance3 <- ggplot(Dance_word_freqs |> 
  ...
  theme(legend.position = "none", 
        plot.background = element_rect(fill = "white", color = "white")) +
     labs(
      caption = "Figure 7: Word cloud for word frequencies in Dance genre in the 1980's") +
     theme_linedraw() +
     theme(plot.caption = ggtext::element_markdown(hjust = 0, vjust = -1
                                                   , size = rel(0.92)
                                                   , color = "#3b3d3c"
...
Similarly, the Dance word clouds portrays word frequencies within the genre across each of the following decades: 1960's, 1970's, and 1980's. @fig-Dance1 shows <b>"baby," "love,"</b> and <b>"chain"</b> as the words with higher frequencies in the Dance genre during the 60's, which is supported by the fact that love was one of the more popular themes in 1960's music. According to @fig-Dance2, <b>"funk"</b> and <b>"light"</b> had high word frequencies is the Dance music genre, given that funk and rhythm were popular in the 1970's. @fig-Dance3 demonstrates <b>"beat"</b> and <b>"call"</b> as words of higher frequencies in the 80's decade of Dance music, which aligns with the fact that telephones popularity skyrocketed during these years, including landlines, answering machines, and payphones. The term "call" became a term of love with these newfound methods of communication. <b>Love, attachment,</b> and <b>funk</b> are words of high frequency in the cumulative Dance genre (all three decades combined), and each decade had words of higher frequencies that were associated with popular themes during each of those years, such as the boogie and funk.
...
Slow <- ggplot(Slow_word_freqs |>
  ...
  theme(legend.position = "none", 
     ...
     labs(
      caption =
        "Figure 8: Word cloud for cumulative Slow genre,decades inclusive") +
     theme_linedraw() +
     theme(plot.caption = ggtext::element_markdown(hjust = 0, vjust = -1
                                                   , size = rel(0.92)
                                                   , color = "#3b3d3c"
