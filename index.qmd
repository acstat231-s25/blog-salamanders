...
- "Claire Albus"
- "Albert Hu"
abstract: "Music is a major source of entertainment that has strongly influenced peoples' lives. This project seeks to investigate different trends in music lyrics through the use of text and sentiment analysis, using data of songs included in the Rolling Stone's Top 500 Greatest Songs of All Time."
---
...
sentiment_by_year = ggplot(sentiment_data_yearly, aes(x = year, y = average_sentiment)) +
  ...
  labs(title = "Average Sentiment of Top 500 Rolling Stone's Songs by Year",
...
sentiment_by_genre = ggplot(sentiment_data_genre, aes(x = genre, y = average_sentiment)) +
  geom_col(fill = "skyblue4", color = "black",
           aes(text = paste0("Genre: ", genre, "<br>",
                             ...
                             "Average BPM (beats per minute): ", average_bpm, "<br>",
                             "Number of Songs: ", num_songs))) +
  labs(title = "Average Sentiment of Top 500 Rolling Stone's Songs by Genre",
...
ggplot(sentiment_data_yearly, aes(x = average_sentiment, y = average_time_seconds)) +
  geom_point() +
  geom_smooth()
```
...
ggplot(sentiment_data_yearly, aes(x = average_sentiment, y = average_bpm)) +
  geom_point() +
  geom_smooth()
```
