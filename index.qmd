...
```{r}
include_graphics("images/cover_image.jpg")
```
...
# 1970s Rock decade
Rock1 <- ggplot(Rock_word_freqs |> filter(decade == "1970"), 
...
# 1980s Rock decade
Rock2 <- ggplot(Rock_word_freqs |> filter(decade == "1980"), 
                aes(label = word, size = n, color = n)) +  
  geom_text_wordcloud(
    family = "sans",             
    random.order = TRUE,           
...
# 1990s Rock decade
Rock3 <- ggplot(Rock_word_freqs |> filter(decade == "1990"), 
                aes(label = word, size = n, color = n)) +  
  geom_text_wordcloud(
    family = "sans",               
    random.order = TRUE,           
...
# 2000s Rock decade
Rock4 <- ggplot(Rock_word_freqs |> filter(decade == "2000"), 
                aes(label = word, size = n, color = n)) +  
  geom_text_wordcloud(
    family = "sans",           
    random.order = TRUE,         
...
# 1960s Dance decade
Dance1 <- ggplot(Dance_word_freqs |> filter(decade == "1960"), 
                aes(label = word, size = n, color = n)) +  
  geom_text_wordcloud(
    family = "sans",             
    random.order = TRUE,           
...
# 1970s Dance decade
Dance2 <- ggplot(Dance_word_freqs |> filter(decade == "1970"), 
                aes(label = word, size = n, color = n)) +  
  geom_text_wordcloud(
    family = "sans",             
    random.order = TRUE,           
...
# 1980s Dance decade
Dance3 <- ggplot(Dance_word_freqs |> filter(decade == "1980"), 
                aes(label = word, size = n, color = n)) +  
  geom_text_wordcloud(
    family = "sans",               
    random.order = TRUE,           
...
sentiment_time_by_song = ggplot(sentiment_data_song, aes(x = time_seconds, y = average_sentiment)) +
  geom_point(color = "skyblue4", size = 0.75,
             aes(text = paste0("Title: ", title, "<br>",
                               "Artist: ", artist, "<br>",
                               "Average Sentiment: ", average_sentiment, "<br>",
                               "Time (sec): ", time_seconds, "<br>",
                               "BPM (beats per minute): ", bpm, "<br>"))) +
  geom_smooth() +
  labs(title = "Average Sentiment versus Time (secs) of 483 Songs on the Top 500 Rolling Stone's Best Songs",
       x = "Time (seconds)", y = "Average Sentiment")
...
sentiment_bpm_by_song = ggplot(sentiment_data_song, aes(x = bpm, y = average_sentiment)) +
  geom_point(color = "skyblue4", size = 0.75,
             aes(text = paste0("Title: ", title, "<br>",
                               "Artist: ", artist, "<br>",
                               "Average Sentiment: ", average_sentiment, "<br>",
