...
ggplot(sentiment_data_yearly, aes(x = year, y = average_sentiment)) +
  geom_point(aes(color = average_time_seconds)) +
  geom_line(color = "skyblue4", linewidth = 0.75, alpha = 0.6) +
  scale_x_continuous(breaks = seq(min(sentiment_data$year), 
                                  max(sentiment_data$year), by = 2)) +
  labs(x = "Year (1953-2006)", y = "Average Sentiment of Lyrics",
       color = "Average Time in Seconds") +
  theme(axis.text.x = element_text(angle = 60, hjust = 1))

sentiment_data_genre = read_csv("data/sentiment_by_genre.csv")

ggplot(sentiment_data_genre, aes(x = average_bpm, y = average_sentiment)) +
...
ggplot(sentiment_data, aes(x = average_sentiment_yearly, y = average_time_seconds)) +
  geom_point() +
  geom_smooth()
```
...
ggplot(sentiment_data, aes(x = average_sentiment_yearly, y = average_bpm)) +
  geom_point() +
  geom_smooth()
```
