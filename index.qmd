...
ggplot(sentiment_data_song, aes(x = time_seconds, y = average_sentiment)) +
  geom_point() +
  geom_smooth() +
  labs(title = "Average Sentiment versus Length (secs) of 483 Songs on the Top 500 Rolling Stone's Best Songs",
       x = "Length (seconds)", y = "Average Sentiment")
```
...
ggplot(sentiment_data_song, aes(x = bpm, y = average_sentiment)) +
  geom_point() +
  geom_smooth() +
